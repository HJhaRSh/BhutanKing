      ...
      <section className="relative w-full h-screen flex items-center justify-center overflow-hidden border-b border-brand-white/20">
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          {[...Array(30)].map((_, i) => (
            <motion.div
              key={i}
              className="absolute w-1 h-1 bg-brand-vibrantGreen rounded-full"
              initial={{
        ...
        <div className="max-w-5xl mx-auto px-6 w-full relative z-10 text-center">
          ...
          >
            <div className="inline-flex items-center gap-2 mb-8 border-b border-brand-vibrantGreen/50 pb-2">
              <Sparkles className="w-4 h-4 text-brand-vibrantGreen" />
              <span className="text-xs font-bold tracking-[0.3em] uppercase text-brand-vibrantGreen">
                SUSTAINABILITY · COMING 2026–2027
              </span>
            </div>
            <h1 className="text-5xl md:text-6xl lg:text-8xl font-display leading-[1] mb-8">
              Bamboo <span className="text-brand-vibrantGreen">Revolution.</span>
            </h1>
      ...
      <section className="w-full py-32 border-b border-brand-white/20">
        <div className="max-w-7xl mx-auto px-6">
          <ScrollReveal delay={0.2} className="grid md:grid-cols-3 gap-12">
            <div className="flex flex-col items-start border-t-2 border-brand-vibrantGreen pt-12 group">
              <Leaf className="w-12 h-12 mb-8 stroke-1 text-brand-vibrantGreen group-hover:scale-110 transition-transform" />
            ...
            <div className="flex flex-col items-start border-t-2 border-brand-vibrantBlue pt-12 group">
              <Users className="w-12 h-12 mb-8 stroke-1 text-brand-vibrantBlue group-hover:scale-110 transition-transform" />
            ...
            <div className="flex flex-col items-start border-t-2 border-brand-vibrantPink pt-12 group">
              <Globe2 className="w-12 h-12 mb-8 stroke-1 text-brand-vibrantPink group-hover:scale-110 transition-transform" />
        ...
        <div className="max-w-5xl mx-auto px-6">
          <div className="border-y border-brand-black py-16 flex flex-col md:flex-row items-center justify-between gap-12">
            <div className="flex flex-col items-center text-center">
              <Clock className="w-16 h-16 mb-6 stroke-1 text-brand-vibrantGreen animate-pulse" />
              <h3 className="text-xs font-bold tracking-[0.2em] uppercase mb-4 text-brand-vibrantGreen">Project Stage</h3>
              <span className="text-3xl font-display bg-brand-vibrantGreen text-brand-black px-6 py-2 rounded-full shadow-lg shadow-brand-vibrantGreen/20">
                UNDER DEVELOPMENT
              </span>
            </div>
            ...
            <div className="flex-1 flex flex-col justify-center">
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-6 border-b border-brand-black/10 pb-4">
