...
export default function NapkinPage() {
  return (
    <div className="w-full flex flex-col items-center bg-creative-light text-brand-black">
      ...
      {/* HERO SECTION */}
      <section className="relative w-full h-[80vh] flex items-end pb-20 justify-start overflow-hidden border-b border-brand-saffron/20">
      ...
      <section className="w-full bg-brand-black text-brand-white py-16 md:py-32">
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <ScrollReveal delay={0.2} className="grid md:grid-cols-3 gap-x-12 gap-y-16 border-t border-brand-orchid/20 pt-16 mb-24">
            <div className="flex flex-col items-center text-center group cursor-pointer">
              <div className="relative w-full aspect-square mb-8 rounded-2xl overflow-hidden bg-gradient-to-br from-brand-gray/80 to-brand-royalViolet/10 border border-brand-orchid/20 hover:border-brand-saffron/60 shadow-lg shadow-brand-royalViolet/10 relative overflow-hidden group-hover:border-brand-orchid transition-colors">
        ...
        <div className="absolute top-0 left-0 right-0 h-[2px] bg-gradient-to-r from-brand-saffron via-brand-orchid to-brand-skyBlue rounded-t-xl" />
            ...
            <div className="flex flex-col items-center text-center group cursor-pointer">
              <div className="relative w-full aspect-square mb-8 rounded-2xl overflow-hidden bg-gradient-to-br from-brand-gray/80 to-brand-royalViolet/10 border border-brand-orchid/20 hover:border-brand-saffron/60 shadow-lg shadow-brand-royalViolet/10 relative overflow-hidden group-hover:border-brand-saffron transition-colors">
        <div className="absolute top-0 left-0 right-0 h-[2px] bg-gradient-to-r from-brand-saffron via-brand-orchid to-brand-skyBlue rounded-t-xl" />
        <div className="absolute top-0 left-0 right-0 h-[2px] bg-gradient-to-r from-brand-saffron via-brand-orchid to-brand-skyBlue rounded-t-xl" />
        ...
        <div className="absolute top-0 left-0 right-0 h-[2px] bg-gradient-to-r from-brand-saffron via-brand-orchid to-brand-skyBlue rounded-t-xl" />
          ...
          <ScrollReveal delay={0.4} className="grid md:grid-cols-2 gap-x-12 gap-y-16 border-t border-brand-orchid/20 pt-16 border-dashed">
            <div className="flex flex-col items-center text-center group cursor-pointer">
              <span className="text-xs tracking-widest text-brand-white/50 uppercase mb-4">Planned</span>
              <div className="relative w-full aspect-[16/9] mb-8 rounded-2xl overflow-hidden bg-gradient-to-br from-brand-gray/80 to-brand-royalViolet/10 border border-brand-orchid/20 hover:border-brand-saffron/60 shadow-lg shadow-brand-royalViolet/10 relative overflow-hidden group-hover:border-brand-orchid transition-colors">
        <div className="absolute top-0 left-0 right-0 h-[2px] bg-gradient-to-r from-brand-saffron via-brand-orchid to-brand-skyBlue rounded-t-xl" />
        <div className="absolute top-0 left-0 right-0 h-[2px] bg-gradient-to-r from-brand-saffron via-brand-orchid to-brand-skyBlue rounded-t-xl" />
      ...
      <section className="w-full py-16 md:py-32 border-b border-brand-saffron/20">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="py-12 border-t border-b border-brand-saffron/20 text-center">
