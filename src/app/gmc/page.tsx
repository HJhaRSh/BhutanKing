    ...
    <div className="w-full flex flex-col items-center bg-brand-black text-brand-white">
      ...
      <section className="relative w-full h-screen flex items-center justify-center overflow-hidden border-b border-brand-white/20">
        <div className="absolute inset-0 z-0">
          <div className="absolute inset-0 bg-gradient-to-br from-brand-black via-brand-black to-brand-vibrantBlue/20" />
        </div>
      ...
      {/* GMC EXPLAINER */}
      <section className="w-full py-32 border-b border-brand-white/20 relative z-20 bg-creative-light text-brand-black">
        <div className="max-w-5xl mx-auto px-6">
          <ScrollReveal className="relative pt-12">
            <div className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2 px-6 py-2 bg-brand-black text-brand-vibrantBlue text-xs uppercase tracking-widest flex items-center gap-2 rounded-full shadow-lg shadow-brand-vibrantBlue/20">
               <Crown className="w-4 h-4" /> Context
            </div>
            <p className="text-3xl md:text-5xl leading-tight text-center font-display">
              "Gelephu Mindfulness City (GMC) is a Special Administrative Region spanning <span className="text-brand-vibrantBlue">2,500 sq km</span> in southern Bhutan, established under Royal Charter by His Majesty the King — masterfully fusing international business, modern technology, and mindful living."
            </p>
          </ScrollReveal>
        </div>
      </section>
      ...
      <section className="w-full py-32 border-b border-brand-white/20">
        <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-20 items-center">
          ...
          <ScrollReveal delay={0.2} className="flex flex-col gap-8 border-l border-brand-white/20 pl-12">
            <div className="flex flex-col">
              <span className="text-5xl md:text-7xl font-display text-brand-vibrantBlue mb-2">2,500<span className="text-3xl ml-1">sq km</span></span>
              <span className="text-sm font-bold tracking-[0.2em] text-brand-white/70 uppercase">Total Size</span>
            </div>
            <div className="flex flex-col border-t border-brand-white/10 pt-8">
              <span className="text-5xl md:text-7xl font-display text-brand-vibrantPink mb-2">SAR</span>
              <span className="text-sm font-bold tracking-[0.2em] text-brand-white/70 uppercase">Special Admin Region</span>
            </div>
            <div className="flex flex-col border-t border-brand-white/10 pt-8">
              <span className="text-5xl md:text-7xl font-display text-brand-vibrantGreen mb-2">Royal Charter</span>
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <ScrollReveal delay={0.2} className="grid md:grid-cols-3 gap-12">
            ...
            <div className="flex flex-col items-center text-center border-t-2 border-brand-vibrantPink pt-12 group">
              <Briefcase className="w-16 h-16 text-brand-vibrantPink mb-8 stroke-1 group-hover:scale-110 transition-transform" />
            ...
            <div className="flex flex-col items-center text-center border-t-2 border-brand-vibrantGreen pt-12 group">
              <Star className="w-16 h-16 text-brand-vibrantGreen mb-8 stroke-1 group-hover:scale-110 transition-transform" />
      ...
      {/* STATUS BANNER */}
      <section className="w-full bg-brand-vibrantBlue py-12 text-center shadow-2xl shadow-brand-vibrantBlue/20">
